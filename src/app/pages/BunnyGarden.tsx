    ...
    <AppShell>
      <div className="mx-auto w-full max-w-[390px]">
        ...
        <section className="mt-2 flex items-center gap-3 rounded-[22px] border border-[rgba(255,255,255,0.8)] bg-[rgba(255,254,250,0.86)] px-3 py-3 shadow-[0_10px_30px_rgba(126,91,72,0.10)] backdrop-blur-[18px]">
          ...
          <button onClick={() => setSeedVaultOpen(true)} className="inline-flex h-11 items-center rounded-[999px] border-0 bg-gradient-to-b from-[#8fc98a] to-[var(--green)] px-3.5 text-[12px] font-extrabold text-white shadow-[0_8px_18px_rgba(119,191,136,0.28),inset_0_1px_rgba(255,255,255,0.35)]">
