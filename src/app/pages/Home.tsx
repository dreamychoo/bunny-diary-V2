  ...
  const emotionAction = (
    ...
    >
      ...
      <span className="min-w-0 flex-1">
        <span className="font-ui block text-sm font-extrabold leading-tight text-[#4a3b34]">{t("home.feelingDownTitle")}</span>
        <span className="mt-1 block text-[11px] leading-[1.3] text-[#7f746e]">{t("home.feelingDownSubtitle")}</span>
      </span>
  ...
  const gridCards = [
    {
      ...
      title: t("home.smallJoysTitle"),
      subtitle: t("home.smallJoysSubtitle"),
      label: language === "zh" ? "温暖" : "Warmth",
      icon: Heart,
      tone: "warm" as const
    },
    {
