...
export function createBunnyLetter(seedIds: string[]) {
  ...
  // Use seed IDs to pick stable indices
...
const notebookLines: Record<"en" | "zh", string[]> = {
  en: [
    ...
    // Bunny's little life lessons 50
    "Bunny got lost on a walk — and ended up seeing flowers that weren't on the map.",
    "It's okay if you didn't level up today. A small potato has its own pace too.",
    "Some answers are like mushrooms — they show up when you stop staring.",
    "Bunny looked back and realized it had come a long way, even stumbling the whole time.",
    "You don't have to step perfectly every time. A wobbly path is still a path.",
    "Some days feel like underproofed bread — but at least they swelled with effort.",
    "Slow is fine. Turtles have their own navigation system.",
    "If all you did today was breathe and eat, you still ran a living-being shift.",
    "Not all growth sparkles. Sometimes it's just a tiny leaf quietly appearing.",
    "Bunny tripped — and found a beautiful cloud reflection on the ground.",
    "Life is like a drawer sometimes. Messy, but you can always find something useful.",
    "Even a crumpled day deserves to be kept safely.",
    "Some views are only discovered after Bunny took the wrong turn.",
    "Don't rush to bloom. First, be a seed that's really good at daydreaming.",
    "Life doesn't hand out awards every day, but sometimes it gives you a cookie.",
    "Bunny thought it hadn't moved at all — it was just walking too quietly.",
    "Some roads aren't straight lines. They're carrots bent by the wind.",
    "You don't have to solve the universe today. First, drink the water in your cup.",
    "Take your time. Even the moon didn't fill up in one night.",
    "Sometimes stopping isn't falling behind. It's changing the battery in your heart.",
    "Bunny packed worries into a box — and found there was still room for cookies.",
    "Life doesn't have to be full battery. Half charge is enough for a walk.",
    "Some changes are like socks — you don't notice them until they're already on.",
    "Don't let today's bad mood review your entire life.",
    "Bunny only moved one centimeter forward today. But centimeters have dignity too.",
    "Some problems are like knotted yarn. Don't pull — drink some water first.",
    "Not blooming today is fine. Maybe there's a underground meeting happening.",
    "Life sometimes takes a detour. Maybe it just wants to take you for bubble tea.",
    "Bunny didn't run fast. But its ears always pointed toward the wind.",
    "One day, the roads you've walked will become a soft cushion beneath you.",
    "Some days are like forgotten dough. Quiet, but still changing.",
    "Bunny didn't find the answer — but found a really good rock to sit on.",
    "Feeling low today is okay. Even clouds don't have a good hair day every day.",
    "Life is like a key that fell into the grass. Keep looking — it'll glint eventually.",
    "Bunny walks slowly because it's carefully avoiding ants on their commute.",
    "You don't need to become a big tree right away. Being a blade of grass that stands steady is already good.",
    "Some worries are like tiny holes in socks. Once you see them, you can slowly mend them.",
    "If you feel a little messy today, maybe you're just being reformatted.",
    "Bunny filled a whole page with plans but only managed to sun its ears. That counts as recharging.",
    "Some growth is like soup — quiet on the surface, but bubbling inside.",
    "You don't have to turn life into a perfect essay. A journal entry is just as real.",
    "Bunny didn't win against the world today — but it successfully beat the snooze button by three minutes.",
    "Some roads feel roundabout because they're helping you avoid a big puddle.",
    "If you only moved a tiny bit today, please give that tiny bit a small award.",
    "Life sometimes crumples you. But crumpled paper can still be folded into a boat.",
    "When Bunny can't figure things out, it waters the plants. They usually don't ask why.",
    "Some wishes are like candy in your pocket. Sweet even when saved for later.",
    "Today, don't try to be someone impressive. First, be someone who's eaten enough.",
    "Bunny looked back and realized the twists and turns had become a map.",
    "You are moving forward. Some steps are just too light for even you to hear.",
  ],
  zh: [
    ...
    // 小兔的人生小感悟 50条
    "小兔走着走着迷路了，结果也看到了没计划里的花。",
    "今天没变厉害也没关系，小土豆也有小土豆的进度。",
    "有些答案像蘑菇，不盯着它的时候，反而自己冒出来。",
    "小兔回头一看，原来笨笨地也走了很远。",
    "不用每一步都踩得很准，歪歪扭扭也是一条路。",
    "有些日子像没睡醒的面包，但也算认真膨胀过。",
    "慢一点没关系，乌龟也有自己的导航系统。",
    "今天只完成了呼吸和吃饭，也算生命体正常营业。",
    "有些成长不是闪闪发光，是悄悄长出一片小叶子。",
    "小兔摔了一跤，顺便发现地上的云影也很好看。",
    "人生有时候像抽屉，乱一点，但总能翻出点有用的。",
    "今天有点皱巴巴，也不影响被好好收藏。",
    "有些风景，是小兔走错路以后才捡到的。",
    "不用急着开花，先当一颗很会发呆的种子。",
    "生活不会每天发奖状，但偶尔会发一块小饼干。",
    "小兔以为自己没前进，结果只是走得太小声了。",
    "有些路不是直线，是一根被风吹弯的胡萝卜。",
    "今天不解决宇宙难题，先把杯子里的水喝掉。",
    "慢慢来，月亮也不是一口气圆起来的。",
    "有时候停下来，不是掉队，是在给心里换电池。",
    "小兔把烦恼装进盒子，发现盒子还能顺便装饼干。",
    "人生不是一定要满格，半格电量也能散步。",
    "有些变化像袜子，找不到的时候，其实已经在脚上了。",
    "不要用今天的坏心情，给整个人生打差评。",
    "小兔今天只往前挪了一厘米，但厘米也有厘米的尊严。",
    "有些难题像打结的毛线，先别扯，喝口水再说。",
    "今天没开花也没事，可能是在地下偷偷开会。",
    "生活有时候会绕路，但也许只是想带你去买奶茶。",
    "小兔没有跑很快，但耳朵一直朝着风的方向。",
    "你走过的路，会在某一天变成一张软软的小垫子。",
    "有些日子像忘记发酵的面团，安静一点，也还是在变。",
    "小兔没有找到答案，但找到了一块很好坐的石头。",
    "今天没精神也没关系，云朵也不是每天都有造型。",
    "人生有时像掉进草丛的钥匙，慢慢找，总会闪一下。",
    "小兔走得慢，是因为它正在认真避开蚂蚁的通勤路线。",
    "不用急着成为大树，先当一棵站稳的小草也很好。",
    "有些烦恼像袜子上的小洞，看见了就能慢慢补。",
    "今天的你如果有点乱，也可能只是正在重新排版。",
    "小兔把计划写满了纸，最后只完成了晒耳朵，也算吸收能量。",
    "有些成长像煮汤，表面没动静，里面已经在咕嘟咕嘟。",
    "不用把生活过成满分作文，流水账也是真实人生。",
    "小兔今天没有赢过世界，但成功赢过了赖床三分钟。",
    "有些路看起来绕，其实是在帮你避开大水坑。",
    "今天如果只前进了一点点，也请给这一点点颁个小奖。",
    "生活偶尔会把人揉皱，但皱皱的纸也能折小船。",
    "小兔想不明白的时候，就先去浇花，花通常不追问原因。",
    "有些心愿像口袋里的糖，晚一点吃，也还是甜的。",
    "今天不用变成厉害的人，先变成吃饱的人。",
    "小兔回头看，发现那些弯弯绕绕也组成了地图。",
    "你不是没有往前走，只是有些脚步轻得连自己都没听见。",
  ]
};
